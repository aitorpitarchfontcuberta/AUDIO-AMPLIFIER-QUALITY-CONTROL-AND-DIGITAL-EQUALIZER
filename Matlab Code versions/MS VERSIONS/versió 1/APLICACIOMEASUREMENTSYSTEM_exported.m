classdef APLICACIOMEASUREMENTSYSTEM_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function RecordButtonPushed(app, event)
            ...
            countdownLabel.Position = [487 315 120 22];
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 640 425];
            ...
            app.WaveformAxes.Position = [1 137 300 185];
            ...
            app.ModeDropDown.Position = [116 385 100 22];
            ...
            app.SignalTypeDropDownLabel.Position = [33 342 68 22];
            ...
            app.SignalTypeDropDown.Position = [116 342 100 22];
            ...
            app.DuracisEditFieldLabel.Position = [259 385 64 22];
            ...
            app.DurationField.Position = [338 385 100 22];
            ...
            app.FField.Position = [338 342 100 22];
            app.FField.Value = 440;

            % Create FFieldLabel
            app.FFieldLabel = uilabel(app.UIFigure);
            app.FFieldLabel.Position = [264 342 59 22];
            ...
            app.PowerEditField.Position = [95 89 100 22];

            % Create GainLabel
            app.GainLabel = uilabel(app.UIFigure);
            app.GainLabel.HorizontalAlignment = 'right';
            app.GainLabel.Position = [248 89 30 22];
            ...
            app.SavewavButton.Position = [33 32 100 22];
            ...
            app.ExportconfigmatButton.Position = [386 32 111 22];
            ...
            app.ImportconfigmatButton.Position = [512 32 110 22];
            ...
            app.ImportwavButton.Position = [149 32 100 22];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = APLICACIOMEASUREMENTSYSTEM_exported
